...
def get_all_predictions(all_examples, all_features, all_results, n_best_size,
...
def get_predictions(example, features, all_results, n_best_size,
...
def read_squad_example(input, question, id):
    def is_whitespace(c):
        if c == " " or c == "\t" or c == "\r" or c == "\n" or ord(c) == 0x202F:
            return True
        return False
